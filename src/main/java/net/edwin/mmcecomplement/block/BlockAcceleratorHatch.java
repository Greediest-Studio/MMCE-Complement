...
/** An eight-tier colorable component that unconditionally shortens recipes. */
public class BlockAcceleratorHatch extends BlockMachineComponent implements BlockCustomName, BlockVariants {

    public static final PropertyEnum<AcceleratorHatchType> TIER =
        PropertyEnum.create("tier", AcceleratorHatchType.class);

    public BlockAcceleratorHatch() {
        super(Material.IRON);
        Block block = this;
        ...
        block.setTranslationKey("mmce_complement.accelerator_hatch");
    ...
    public void addInformation(@Nonnull ItemStack stack, @Nullable World world,
        ...
        tooltip.add(I18n.format("tile.mmce_complement.accelerator_hatch.tip.duration",
            multiplier));
        tooltip.add(I18n.format("tile.mmce_complement.accelerator_hatch.tip.highest_only"));
    }

    @Override
    public void getSubBlocks(CreativeTabs tab, NonNullList<ItemStack> items) {
        for (AcceleratorHatchType type : AcceleratorHatchType.values()) {
    ...
    public IBlockState getStateFromMeta(int meta) {
        AcceleratorHatchType[] values = AcceleratorHatchType.values();
    ...
    public String getIdentifierForMeta(int meta) {
        return AcceleratorHatchType.fromMeta(meta).getName();
    }
    ...
    public enum AcceleratorHatchType implements IStringSerializable {
        MK1,
        MK2,
        MK3,
        MK4,
        ...
        public static AcceleratorHatchType fromMeta(int meta) {
            AcceleratorHatchType[] values = values();
