...
/** Four-isolated-tank input hatch with the same eight sizes as MMCE. */
public class BlockQuadFluidInputHatch extends BlockMachineComponent
    ...
    public BlockQuadFluidInputHatch() {
        super(Material.IRON);
        Block block = this;
        ...
        block.setTranslationKey("mmce_complement.quad_fluid_input_hatch");
    ...
    public void addInformation(@Nonnull ItemStack stack, @Nullable World world,
        ...
        int capacity = TileQuadFluidInputHatch.capacityForTotal(totalCapacity);
        ...
        tooltip.add(TextFormatting.GRAY + I18n.format(
            "tile.mmce_complement.quad_fluid_input_hatch.tip.isolated"));
        tooltip.add(TextFormatting.GRAY + I18n.format(
            "tile.mmce_complement.quad_fluid_input_hatch.tip.mixed"));
