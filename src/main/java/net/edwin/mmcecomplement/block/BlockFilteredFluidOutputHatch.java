...
/** One-tank fluid output with an exact ghost filter and int-max capacity. */
public class BlockFilteredFluidOutputHatch extends BlockMachineComponent {

    public BlockFilteredFluidOutputHatch() {
        super(Material.IRON);
        Block block = this;
        ...
        block.setTranslationKey("mmce_complement.filtered_fluid_output_hatch");
    ...
    public boolean onBlockActivated(World world, BlockPos pos, IBlockState state,
        ...
        if (!world.isRemote && world.getTileEntity(pos)
            instanceof TileFilteredFluidOutputHatch) {
            player.openGui(MMCEComplement.instance,
                MMCEComplement.GUI_FILTERED_FLUID_OUTPUT_HATCH,
    ...
    public void addInformation(@Nonnull ItemStack stack, @Nullable World world,
        ...
        tooltip.add(I18n.format(
            "tile.mmce_complement.filtered_fluid_output_hatch.tip.1"));
        tooltip.add(I18n.format(
            "tile.mmce_complement.filtered_fluid_output_hatch.tip.2"));
        tooltip.add(I18n.format(
    ...
    @Nullable @Override public TileEntity createNewTileEntity(@Nonnull World world, int meta) { return new TileFilteredFluidOutputHatch(); }
    @Nullable @Override public TileEntity createTileEntity(@Nonnull World world, @Nonnull IBlockState state) { return new TileFilteredFluidOutputHatch(); }
}
